...
#pragma config(Motor,  motor2,          RMotor,        tmotorVexIQ, PIDControl, reversed, encoder)
#pragma config(Motor,  motor3,          Strafe,        tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor4,          LeftHubArm,    tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor5,          RightHubArm,   tmotorVexIQ, PIDControl, encoder)
#pragma config(Motor,  motor6,          SlideArm,      tmotorVexIQ, PIDControl, encoder)
