...
#pragma config(Motor,  motor4,          RMotor,        tmotorVexIQ, PIDControl, reversed, encoder)
#pragma config(Motor,  motor5,          RHerder,       tmotorVexIQ, PIDControl, reversed, encoder)
